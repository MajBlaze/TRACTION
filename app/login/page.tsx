...
export default function LoginPage() {
  ...
  return (
    <div className="relative min-h-[100dvh] overflow-hidden pb-0 bg-[radial-gradient(circle_at_top,_rgba(124,147,255,0.28),_transparent_30%),radial-gradient(circle_at_20%_20%,_rgba(255,255,255,0.08),_transparent_20%),linear-gradient(180deg,_#07111f_0%,_#0a1930_42%,_#13223b_100%)]">
      <AuthSnowfall />
      ...
      <div className="relative z-10 flex min-h-[100dvh] items-start justify-center px-4 pt-6 pb-0 md:items-center md:p-8">
        <div className="w-full max-w-md space-y-5 md:max-w-lg md:space-y-8">
          <div className="flex flex-col items-center space-y-4 text-center">
            ...
            <p className="italic text-slate-200/85">
          ...
          <Card className="rounded-[2rem] border border-white/15 bg-slate-950/38 shadow-[0_30px_90px_rgba(0,0,0,0.35)] backdrop-blur-2xl">
            ...
            <CardContent className="space-y-6">
              ...
              <Button variant="outline" className="h-12 w-full rounded-xl" onClick={handleGoogleSignIn}>
